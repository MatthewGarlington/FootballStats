//
//  ChampionshipTopScorersDataController.swift
//  leagueTable
//
...
class ChampionshipTopScorersDataController: ObservableObject {


    @Published var championshipTopScorerInfo: ChampionshipTopScorerInfo?
    init() {
    //https://app.sportdataapi.com/api/v1/soccer/topscorers?apikey=599d1b80-0d6e-11ec-a549-9d6e6fe2c510&season_id=1980
        let url = URL(string: "https://app.sportdataapi.com/api/v1/soccer/topscorers?apikey=\(APIKEY)&season_id=2014")!
...
//             update UI using the response here
            ...
            DispatchQueue.main.async {
                ...
                do {
                    self.championshipTopScorerInfo = try JSONDecoder().decode(ChampionshipTopScorerInfo?.self, from: data)
